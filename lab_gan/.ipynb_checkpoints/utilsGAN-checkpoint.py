...
def plot_sample_classification_results(data, truth, classes, predictions,test_acc, batch_size=25):
...
def plot_sample_segmentation_results(data, truth, predictions,test_acc, batch_size=8):
...
def plot_sample_data_with_groundtruth(data, truth, batch_size=4):
...
def plot_sample_futureframepredictor_data_with_groundtruth(data, truth, pred, batch_size=4):
