...
class Pix2Pix_model_v8(BaseModel):
    __name__='Pix2Pix_model_v8'
    __changes__="Changed to a pix2pix model in order to test a greater network for generator and discriminator. Generator: U-Net, Discriminator: PatchGAN. Testing with smaller batch sizes"
    __train__= 'pix2pix_minibatches'
    __norm__='[-1,1]'
    __jitter__= True
