...
class Pix2Pix_model_v6(BaseModel):
    __name__='Pix2Pix_model_v6'
    __changes__="Changed to a pix2pix model in order to test a greater network for generator and discriminator. Generator: U-Net, Discriminator: PatchGAN.. Disable Jitter. Lowered learning rate on Adam"
    __train__= 'pix2pix'
    __norm__='[-1,1]'
    __jitter__= False
