...
class Pix2Pix_model_v7(BaseModel):
    __name__='Pix2Pix_model_v7'
    __changes__="Changed to a pix2pix model in order to test a greater network for generator and discriminator. Generator: U-Net, Discriminator: PatchGAN. Lowered learning rate on Adam. beta_1 to 0 and b2 to 0.9 - According to Improved Training of Wasserstein GANs, 2017"
    __train__= 'pix2pix'
    __norm__='[-1,1]'
    __jitter__= True
