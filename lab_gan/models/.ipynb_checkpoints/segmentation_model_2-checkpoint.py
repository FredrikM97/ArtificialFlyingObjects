...
class segmentation_model_v2(BaseModel):
    __name__='segmentation_model_v2'
    __changes__="Model based on segmentation lab. Change from tanh to sigmoid and changing distribution to 0-1 instead of -1 and 1"
    __train__= 'pix2pix'
    __norm__='[0,1]'
    __jitter__= True
    ...
    def generator(self):
        ...
        def main():
            ...
            classify = Conv2DTranspose(3, kernel_size=2,  strides=(2,2), activation='sigmoid')(u4)
