...
class Pix2Pix_model_v5(BaseModel):
    __name__='Pix2Pix_model_v5'
    __changes__="Changed to a pix2pix model in order to test a greater network for generator and discriminator. Generator: U-Net, Discriminator: PatchGAN. Changed Discriminator optimizer to SGD. Lowered learning rate for SGD to 2e-4"
    __train__= 'pix2pix'
    __norm__='[-1,1]'
    __jitter__= True
    
    g_optimizer = tf.keras.optimizers.Adam(2e-4, beta_1=0.5)
    d_optimizer = tf.keras.optimizers.SGD(learning_rate=2e-4)
